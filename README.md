...
## ✒ 커밋 방법
- 3번 필사하되, 3개중 정리된 첫번째 노트북만 커밋한다. 
- 필사하는 첫번째 notebook에서는 `overall`을 반드시 작성하여 전반적인 흐름을 정리할 수 있도록 한다.  
...
- [x] [eda to prediction(dietanic)](https://www.kaggle.com/ash316/eda-to-prediction-dietanic)
- [x] [titanic top 4% with ensemble modeling](https://www.kaggle.com/yassineghouzam/titanic-top-4-with-ensemble-modeling)
- [x] [introduction to ensembling/stacking in python](https://www.kaggle.com/arthurtok/introduction-to-ensembling-stacking-in-python)
